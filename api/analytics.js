...
//     // NEW: If school_id is provided, get the SPECIFIC school's sync status
...
//       schoolSpecificSyncStatus = schoolSyncResult.recordset[0] || null;
//     }
...
//     // NEW: Add school-specific sync status if available
//     if (schoolSpecificSyncStatus) {
//       responseData.sync_status = schoolSpecificSyncStatus.sync_status; // 'online', 'offline', 'warning'
//       responseData.sync_last_heartbeat = schoolSpecificSyncStatus.LastHeartbeat;
      
//       console.log(`School ${schoolId} sync status: ${schoolSpecificSyncStatus.sync_status}`);
//     }
